...
namespace IDL.Giftcloud.Api.OpenIddict
{
    public static class OpenIddictExtensions
    {
        ...
        public static Type FindGenericBaseType(this Type type, Type definition) =>
            type.FindGenericBaseTypes(definition).FirstOrDefault();
        ...
        /// <param name="definition">The generic type definition.</param>
        /// <returns>
        /// A collection of <see cref="Type"/> instances if the base type was found,
        /// an empty collection otherwise.
        /// </returns>
        public static IEnumerable<Type> FindGenericBaseTypes(this Type type, Type definition)
        {
            if (type == null)
            {
